...
namespace CyberSalt\Component\Whmcsbridge\Administrator\View\Products;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        ToolbarHelper::title(Text::_('COM_WHMCSBRIDGE_PRODUCTS'), 'cube');

        if (Factory::getApplication()->getIdentity()->authorise('whmcsbridge.sync', 'com_whmcsbridge')) {
            ToolbarHelper::custom('sync.products', 'refresh', '', 'COM_WHMCSBRIDGE_SYNC_NOW', false);
        }
